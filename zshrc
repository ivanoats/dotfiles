...
export PATH=.:./bin:/Users/ivan/bin:/usr/local/heroku/bin:/usr/local/bin:/usr/local/sbin:/usr/local/mysql/bin:/Developer/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/X11/bin:/Users/ivan/.rvm/bin:$PATH
